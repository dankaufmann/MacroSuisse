...
# Compute risk premia
#-------------------------------------------------------------------------------------
download.file(url = "https://www.bfs.admin.ch/bfsstatic/dam/assets/7966853/master", destfile = "./S01E02_PrimeDeRisque/Defaults_OFS.xlsx", mode="wb")
download.file(url = "https://www.six-group.com/exchanges/downloads/indexdata/hsb_maturity_gov_y.csv", destfile = "./S01E02_PrimeDeRisque/ObligationsConf.csv", mode="wb")
download.file(url = "https://www.six-group.com/exchanges/downloads/indexdata/hsb_maturity_dom_non_gov_rating_sbi_y.csv", destfile = "./S01E02_PrimeDeRisque/ObligationsEnt.csv", mode="wb")

Gov      <- read.csv("./S01E02_PrimeDeRisque/ObligationsConf.csv", sep = ";", skip = 4)
NonGov   <- read.csv("./S01E02_PrimeDeRisque/ObligationsEnt.csv", sep = ";", skip = 4)
Defaults <- read.xlsx("./S01E02_PrimeDeRisque/Defaults_OFS.xlsx", sheetName = "T6.2.3.1", as.data.frame = TRUE)

# Beginning of default procedures (Ouverture des proc?dures de faillite)
...
p
ggsave(filename = "./S01E02_PrimeDeRisque/Obligations.png", width = 5, height = 4)
...
p
ggsave(filename = "./S01E02_PrimeDeRisque/PrimesDeRisque.png", width = 5, height = 4)
...
p <- p + theme_minimal() + ylab("")+xlab("")+
  ...
  theme(panel.grid.major = element_line(colour = "black",size=0.1,linetype="dotted"), panel.grid.minor = element_blank())
p
ggsave(filename = "./S01E02_PrimeDeRisque/ProcFaillitePrime.png", width = 5, height = 4)
